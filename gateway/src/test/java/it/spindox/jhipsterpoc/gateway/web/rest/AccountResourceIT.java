...
import static it.spindox.jhipsterpoc.gateway.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static it.spindox.jhipsterpoc.gateway.test.util.OAuth2TestUtil.authenticationToken;
import static it.spindox.jhipsterpoc.gateway.test.util.OAuth2TestUtil.registerAuthenticationToken;
