package it.spindox.jhipsterpoc.gateway.config.apidocs;

import static it.spindox.jhipsterpoc.gateway.config.apidocs.GatewaySwaggerResourcesProvider.swaggerResource;
