...
import { CategoryService } from 'app/entities/products/category/service/category.service';
...
describe('Product Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Category query and add missing value', () => {
      ...
      const category: ICategory = { id: 9625 };
      product.category = category;

      const categoryCollection: ICategory[] = [{ id: 30009 }];
    ...
    it('Should update editForm', () => {
      const product: IProduct = { id: 456 };
      const category: ICategory = { id: 10565 };
      product.category = category;
