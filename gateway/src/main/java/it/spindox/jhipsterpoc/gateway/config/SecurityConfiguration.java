...
import it.spindox.jhipsterpoc.gateway.security.oauth2.AudienceValidator;
import it.spindox.jhipsterpoc.gateway.security.oauth2.JwtGrantedAuthorityConverter;
import it.spindox.jhipsterpoc.gateway.web.filter.SpaWebFilter;
