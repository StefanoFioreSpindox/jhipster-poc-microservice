...
```
$ docker image tag gateway stefanofiorespindox/gateway
$ docker push stefanofiorespindox/gateway
$ docker image tag products stefanofiorespindox/products
$ docker push stefanofiorespindox/products
```
