...
import it.spindox.jhipsterpoc.products.IntegrationTest;
import it.spindox.jhipsterpoc.products.domain.Product;
import it.spindox.jhipsterpoc.products.repository.ProductRepository;
import it.spindox.jhipsterpoc.products.service.dto.ProductDTO;
import it.spindox.jhipsterpoc.products.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).quantity(DEFAULT_QUANTITY);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).quantity(UPDATED_QUANTITY);
        return product;
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).quantity(UPDATED_QUANTITY);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).quantity(UPDATED_QUANTITY);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).quantity(UPDATED_QUANTITY);
